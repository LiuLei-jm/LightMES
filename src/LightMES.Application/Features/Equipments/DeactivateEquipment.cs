...
public class DeactivateEquipmentCommandHandler : IRequestHandler<DeactivateEquipmentCommand, Unit>
{
    ...
    public DeactivateEquipmentCommandHandler(IAppDbContext context, ICurrentUserService currentUserService)
    {
        _context = context;
        _currentUserService = currentUserService;
    }

    public async Task<Unit> Handle(DeactivateEquipmentCommand request, CancellationToken cancellationToken)
    {
